...
<head>
    ...
    <title>分销商品管理</title>
    <meta charset="utf-8"/>
    <meta name="description" content="分销商品管理"/>
    <meta name="keywords" content="分销商品管理"/>

    <#include "/common/macro.ftl">

    <@css/>
    <link href="${csRoot}pages/distributionGoodsManage.css" rel="stylesheet" type="text/css"/>
</head>
<body>
    <!-- content -->
    ...
    <script>
        NEJ.define([
            'pro/pages/distributionGoodsManage/index'
        ],function(m){
